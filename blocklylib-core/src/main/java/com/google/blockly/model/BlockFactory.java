...
public class BlockFactory {
    ...
    public void applyMutator(String mutatorId, Block block) throws BlockLoadingException {
        ...
        Field mutatorField = null;
        // Add the mutator edit field if appropriate
        if (mutator.hasUI()) {
            mutatorField = new FieldMutator("MUTATOR_FIELD", R.drawable.mutator_icon_24dp, 24, 24,
                    mMutatorAltText);
        }

        block.setMutator(mutator, mutatorId, mutatorField);
