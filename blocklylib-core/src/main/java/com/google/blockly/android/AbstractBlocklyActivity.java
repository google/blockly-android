 ...
 * the {@link WorkspaceFragment}, the toolbox's {@link FlyoutFragment} and {@link CategorySelectorFragment},
 * and the trash's {@link FlyoutFragment} via fragment ids {@link R.id#blockly_workspace},
 * {@link R.id#blockly_flyout}, {@link R.id#blockly_categories}, and {@link R.id#blockly_trash}. If
 * overriding {@link #onCreateContentView} without {@code unified_blockly_workspace.xml} or those
 * fragment ids, override {@link #onCreateFragments()}, appropriately.
 * <p/>
