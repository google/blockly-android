...
public class Dragger {
    ...
    public interface DragHandler {
         ...
         * {@link BlockGroup}, which must contain a root block on the {@link Workspace} and added to
         * the {@link WorkspaceView}.
         *
         * @param pendingDrag The pending drag state in question.
         * @return Whether the drag is ready to start and a draggable {@link BlockGroup} was
         *         assigned.
         */
    ...
    boolean onTouchBlockImpl(DragHandler dragHandler, BlockView touchedView, MotionEvent event,
        ...
        // TODO(#200): The following line breaks drag offset when dragging via a shadow out of a
        //     BlockListView. Move this (and related offset calculations) into DragHandler.
