...
public class BlocklyController {
    ...
    private final Dragger.DragHandler mWorkspaceDragHandler = new Dragger.DragHandler() {
        ...
        public boolean maybeStartDrag(PendingDrag pendingDrag) {
            ...
            // be assigned correct from the most recent layout pass.
    ...
    /**
     * Moves a block from the trashed blocks, back to the workspace.
     *
     ...
     *
     * @throws IllegalArgumentException If trashedBlock is not found among removed blocks.
     */
