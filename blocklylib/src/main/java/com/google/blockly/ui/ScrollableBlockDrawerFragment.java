 ...
 */
public abstract class ScrollableBlockDrawerFragment extends Fragment {
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.ScrollableBlockDrawerFragment,
                0, 0);
        try {
            setCloseable(a.getBoolean(R.styleable.ScrollableBlockDrawerFragment_closeable,
                    mCloseable));
            setScrollOrientation(
                    a.getInt(R.styleable.ScrollableBlockDrawerFragment_scrollOrientation,
                    mScrollOrientation));
        } finally {
            a.recycle();
        }
