...
public abstract class AbstractInputView extends NonPropagatingViewGroup implements InputView {
    private static final String TAG = "AbstractInputView";
    ...
    private BlockGroup mConnectedBlockGroup = null;
     ...
     */
    public void setConnectedBlockGroup(BlockGroup childView) {
        if (mConnectedBlockGroup != null) {
        ...
        addView(childView);
        mConnectedBlockGroup = childView;
        requestLayout();
    }
    ...
    public BlockGroup disconnectBlockGroup() {
        BlockGroup result = mConnectedBlockGroup;
        if (mConnectedBlockGroup != null) {
            removeView(mConnectedBlockGroup);
            mConnectedBlockGroup = null;
            requestLayout();
        }
    ...
    public void unlinkModelAndSubViews() {
        ...
        if (mConnectedBlockGroup != null) {
            mConnectedBlockGroup.unlinkModelAndSubViews();
