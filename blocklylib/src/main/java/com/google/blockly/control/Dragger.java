...
public class Dragger {
     ...
     * toolbox and doing coordinate conversions.
     *
     * @param startX The starting x position, in {@link WorkspaceView} coordinates.
     * @param startY The starting y position, in {@link WorkspaceView} coordinates.
     */
    public void setDragStartPos(int startX, int startY) {
    ...
    private void handleActionDown(BlockView blockView, MotionEvent event) {
        ...
        setDragStartPos(mTempViewPoint.x + startX, mTempViewPoint.y + startY);
    }
