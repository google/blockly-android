...
import com.google.blockly.ui.ScrollableBlockDrawerFragment;
 ...
 */
public class ToolboxFragment extends ScrollableBlockDrawerFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Read configure
        readArgumentsFromBundle(getArguments());
        readArgumentsFromBundle(savedInstanceState);  // Overwrite XML attributes or initial args.
    ...
    public void setContents(final ToolboxCategory topLevelCategory) {
        // Fake Data.... DELETE BEFORE COMMIT
        topLevelCategory.mCategoryName = "Top Level";
        ToolboxCategory first = new ToolboxCategory();
        first.mCategoryName = "First fake";
        ToolboxCategory second = new ToolboxCategory();
        second.mCategoryName = "Second fake";
        topLevelCategory.addSubcategory(first);
        topLevelCategory.addSubcategory(second);
    ...
    // TODO(XXX): Add mBlockList animation hooks for subclasses.
