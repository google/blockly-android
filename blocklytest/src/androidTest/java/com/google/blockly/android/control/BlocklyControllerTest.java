...
public class BlocklyControllerTest extends MockitoAndroidTestCase {
    ...
    private void testConnect_outputToInput(boolean withViews) {
        ...
        if (withViews) {
            ...
            ((TestableBlockGroup) mHelper.getRootBlockGroup(target))
                    .setWorkspaceView(mWorkspaceView);
            ((TestableBlockGroup) mHelper.getRootBlockGroup(source))
                    .setWorkspaceView(mWorkspaceView);
        }
    ...
    private void testConnect_outputToInputBumpMultipleInputs(boolean withViews) {
        ...
        if (withViews) {
            ...
            // Fake onAttachToWindow()
            ((TestableBlockGroup) mHelper.getParentBlockGroup(target))
                    .setWorkspaceView(mWorkspaceView);
            ((TestableBlockGroup) mHelper.getParentBlockGroup(source))
                    .setWorkspaceView(mWorkspaceView);
        }
    ...
    private void testExtractAsRootBlock_alreadyRoot(boolean withViews) {
        ...
        if (withViews) {
            ...
            // Fake onAttachToWindow()
            ((TestableBlockGroup) mHelper.getRootBlockGroup(block))
                    .setWorkspaceView(mWorkspaceView);
        }
    ...
    private void testExtractBlockAsRoot_fromInput(boolean withViews) {
        ...
        if (withViews) {
            ...
            // Fake onAttachToWindow()
            ((TestableBlockGroup) mHelper.getRootBlockGroup(first))
                    .setWorkspaceView(mWorkspaceView);
        }
